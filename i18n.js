...
const I18n = (() => {
  ...
  const MESSAGES = {
    es: {
      ...
      popupOrderHint: 'Arrastra las asas (⋮⋮) para cambiar el orden en el que se muestran.',
      ariaDrag: 'Arrastra para reordenar',
      ...
      decimalLabel: 'Decimales del precio:',
      labelTotal: '💰 Total:',
    ...
    en: {
      ...
      popupOrderHint: 'Drag the handles (⋮⋮) to change the display order.',
      ariaDrag: 'Drag to reorder',
